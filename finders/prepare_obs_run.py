...
def do_obsrun(filename, telescope, rotate=False, debug=False, 
    max_offset_star_radius=None, max_mag=None, noffset=3, min_sep=5):
    ...
    for i in range(len(table)):
        if skip_host == False: #this entry is not host, treat as target
            ...
            starlist_entry, outimagename = get_finder(ra_deg, dec_deg, name,  
                            ...
                            num_offset_stars = noffset, min_separation = min_sep,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--noffset", type=int, default=1,
        help="Maximum offset star magnitude")
